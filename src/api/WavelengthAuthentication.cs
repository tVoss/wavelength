...
namespace Wavelength.Api
{
    ...
    public class WavelengthAuthenticationMiddleware : AuthenticationMiddleware<WavelengthAuthenticationOptions>
    {
        ...
        {
            return new WavelengthAuthenticationHandler(_facebookApi);
        }

    }

    public class WavelengthAuthenticationHandler : AuthenticationHandler<WavelengthAuthenticationOptions>
    {
        private FacebookApi _facebookApi;

        public WavelengthAuthenticationHandler(FacebookApi facebookApi)
        {
            _facebookApi = facebookApi;
        }
